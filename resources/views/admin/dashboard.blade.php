                                ...
                                <div class="row">
                                        ...
                                        <div class="d-flex flex-column flex-xl-row mt-4 mt-md-0">
                                            ...
                                            <div class="content text-white">
                                                <div class="d-flex flex-wrap align-items-center mb-2 mt-3 mt-xl-1">
                                                    <h3 class="font-weight-light mr-2 mb-1">Revenue
                                                    </h3>
                                    ...
                                    <div class="col-md-4 item">
                                        <div class="d-flex flex-column flex-xl-row mt-5 mt-md-0">
                                            ...
                                            <div class="content text-white">
                                                <div class="d-flex flex-wrap align-items-center mb-2 mt-3 mt-xl-1">
                                                    <h3 class="font-weight-light mr-2 mb-1">Purchases
                                                    </h3>
                                ...
                                <div class="row">
                                    <div class="col-md-4 item">
                                        <div class="d-flex flex-column flex-xl-row mt-4 mt-md-0">
                                            ...
                                            <div class="content text-white">
                                                <div class="d-flex flex-wrap align-items-center mb-2 mt-3 mt-xl-1">
                                                    <h3 class="font-weight-light mr-2 mb-1">Clients
                                                    </h3>
                                    ...
                                    <div class="col-md-4 item">
                                        <div class="d-flex flex-column flex-xl-row mt-5 mt-md-0">
                                            ...
                                            <div class="content text-white">
                                                <div class="d-flex flex-wrap align-items-center mb-2 mt-3 mt-xl-1">
                                                    <h3 class="font-weight-light mr-2 mb-1">Bookings
                                                    </h3>

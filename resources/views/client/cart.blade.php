...
@section('content')
    <div class="hero-wrap hero-bread" style="background-image: url('client/images/pexels-artem-beliaikin-994523.jpg');">
        <div class="container">
                    ...
                    <div class="cart-list">
                        <table class="table">
                           ...
                           <tbody>
                            ...
                            <tr class="text-center">
                                <td class="product-remove"><a href="/retirer_produit/{{$product['product_id']}}"><span class="ion-ios-close"></span></a>
                                </td>
